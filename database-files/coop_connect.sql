...
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Database Administrator II', 'Duis mattis egestas metus. Aenean fermentum. Donec ut mauris eget massa tempor convallis.', false, 27, 'London', 'Djembe', 'Suspendisse ornare consequat lectus.', '38');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Web Designer IV', 'Nullam molestie nibh in lectus. Pellentesque at nulla. Suspendisse potenti.', true, 97, 'London', 'BDC', 'In hac habitasse platea dictumst.', '10');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Nurse Practicioner', 'In eleifend quam a odio. In hac habitasse platea dictumst.', true, 57, 'Chicago', 'RPT', 'Nulla facilisi.', '34');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Programmer Analyst IV', 'Proin leo odio, porttitor id, consequat in, consequat ut, nulla. Sed accumsan felis. Ut at dolor quis odio consequat varius.', true, 13, 'Chicago', 'HTML5', 'Maecenas leo odio, condimentum id, luctus nec, molestie sed, justo.', '36');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Help Desk Technician', 'Cras mi pede, malesuada in, imperdiet et, commodo vulputate, justo. In blandit ultrices enim. Lorem ipsum dolor sit amet, consectetuer adipiscing elit.', false, 22, 'Charlotte', 'VTK', 'Quisque id justo sit amet sapien dignissim vestibulum.', '9');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Senior Cost Accountant', 'Integer a nibh. In quis justo.', false, 3, 'New York City', 'Programming', 'Nullam varius.', '25');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Product Engineer', 'Aliquam erat volutpat. In congue. Etiam justo.', true, 19, 'Toronto', 'Water Resources', 'Duis aliquam convallis nunc.', '17');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Dental Hygienist', 'Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Etiam vel augue.', true, 91, 'Chicago', 'Human Resource Planning', 'Nulla ac enim.', '16');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Dental Hygienist', 'Maecenas ut massa quis augue luctus tincidunt. Nulla mollis molestie lorem.', true, 74, 'Miami', 'MKS Integrity', 'In eleifend quam a odio.', '40');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Sales Associate', 'In blandit ultrices enim. Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Proin interdum mauris non ligula pellentesque ultrices.', true, 66, 'Boston', 'TTCN', 'Cras non velit nec nisi vulputate nonummy.', '11');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Senior Editor', 'Fusce posuere felis sed lacus. Morbi sem mauris, laoreet ut, rhoncus aliquet, pulvinar sed, nisl.', false, 48, 'New York City', 'Operational Planning', 'Nulla facilisi.', '23');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Professor', 'Duis mattis egestas metus. Aenean fermentum.', false, 73, 'Miami', 'Lumion', 'Aenean sit amet justo.', '1');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Nuclear Power Engineer', 'Aenean auctor gravida sem. Praesent id massa id nisl venenatis lacinia.', true, 36, 'New York City', 'MCSA', 'Sed accumsan felis.', '20');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('VP Quality Control', 'Morbi vestibulum, velit id pretium iaculis, diam erat fermentum justo, nec condimentum neque sapien placerat ante. Nulla justo.', false, 98, 'Toronto', 'VCT', 'Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nulla dapibus dolor vel est.', '39');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Project Manager', 'Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Mauris viverra diam vitae quam. Suspendisse potenti.', false, 98, 'Toronto', 'Geometric Dimensioning &amp; Tolerancing', 'Nullam sit amet turpis elementum ligula vehicula consequat.', '14');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Desktop Support Technician', 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Proin risus. Praesent lectus.', true, 35, 'Boston', 'Wholesale Operations', 'Nulla ac enim.', '29');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Web Developer I', 'Suspendisse accumsan tortor quis turpis. Sed ante. Vivamus tortor.', true, 72, 'Los Angeles', 'HDV', 'Morbi sem mauris, laoreet ut, rhoncus aliquet, pulvinar sed, nisl.', '35');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Help Desk Technician', 'In tempor, turpis nec euismod scelerisque, quam turpis adipiscing lorem, vitae mattis nibh ligula nec sem. Duis aliquam convallis nunc. Proin at turpis a pede posuere nonummy.', true, 47, 'Chicago', 'Abstracting', 'Sed ante.', '32');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('GIS Technical Architect', 'Quisque erat eros, viverra eget, congue eget, semper rutrum, nulla. Nunc purus. Phasellus in felis.', true, 13, 'New York City', 'Industrial Ethernet', 'Donec ut mauris eget massa tempor convallis.', '18');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Civil Engineer', 'In hac habitasse platea dictumst. Maecenas ut massa quis augue luctus tincidunt. Nulla mollis molestie lorem.', false, 90, 'Boston', 'Cluster', 'Nulla suscipit ligula in lacus.', '4');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Financial Advisor', 'Proin at turpis a pede posuere nonummy. Integer non velit.', false, 40, 'New York City', 'Award Winner', 'Donec ut dolor.', '2');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Marketing Manager', 'Suspendisse potenti. In eleifend quam a odio. In hac habitasse platea dictumst.', true, 43, 'Los Angeles', 'RCP', 'Phasellus id sapien in sapien iaculis congue.', '28');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Administrative Assistant III', 'Nam nulla. Integer pede justo, lacinia eget, tincidunt eget, tempus vel, pede. Morbi porttitor lorem id ligula.', true, 49, 'Toronto', 'JCAHO', 'Nulla nisl.', '7');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Web Developer II', 'In est risus, auctor sed, tristique in, tempus sit amet, sem. Fusce consequat.', true, 10, 'New York City', 'LN', 'Aliquam augue quam, sollicitudin vitae, consectetuer eget, rutrum at, lorem.', '31');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Research Associate', 'Aenean fermentum. Donec ut mauris eget massa tempor convallis. Nulla neque libero, convallis eget, eleifend luctus, ultricies eu, nibh.', true, 54, 'Boston', 'Sybase IQ', 'Suspendisse potenti.', '27');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Food Chemist', 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Proin interdum mauris non ligula pellentesque ultrices. Phasellus id sapien in sapien iaculis congue.', true, 60, 'New York City', 'nCloth', 'Vestibulum ac est lacinia nisi venenatis tristique.', '8');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Marketing Assistant', 'Vivamus vestibulum sagittis sapien. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.', false, 55, 'Miami', 'Power Systems', 'Cras non velit nec nisi vulputate nonummy.', '22');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Payment Adjustment Coordinator', 'Duis aliquam convallis nunc. Proin at turpis a pede posuere nonummy. Integer non velit.', true, 65, 'Boston', 'CFII', 'Mauris enim leo, rhoncus sed, vestibulum sit amet, cursus id, turpis.', '5');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Senior Sales Associate', 'Vestibulum ac est lacinia nisi venenatis tristique. Fusce congue, diam id ornare imperdiet, sapien urna pretium nisl, ut volutpat sapien arcu sed augue. Aliquam erat volutpat.', false, 76, 'Toronto', 'LDAP Administration', 'Etiam justo.', '15');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Recruiting Manager', 'Maecenas leo odio, condimentum id, luctus nec, molestie sed, justo. Pellentesque viverra pede ac diam.', true, 41, 'Chicago', 'BSP', 'Nulla ut erat id mauris vulputate elementum.', '13');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('VP Accounting', 'Mauris ullamcorper purus sit amet nulla. Quisque arcu libero, rutrum ac, lobortis vel, dapibus at, diam.', true, 97, 'Charlotte', 'Utilization Management', 'Duis consequat dui nec nisi volutpat eleifend.', '12');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Web Designer IV', 'Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Donec pharetra, magna vestibulum aliquet ultrices, erat tortor sollicitudin mi, sit amet lobortis sapien sapien non mi. Integer ac neque. Duis bibendum.', true, 83, 'Charlotte', 'FP7', 'Donec odio justo, sollicitudin ut, suscipit a, feugiat et, eros.', '6');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Nuclear Power Engineer', 'Duis at velit eu est congue elementum. In hac habitasse platea dictumst.', true, 28, 'Boston', 'Social Media Marketing', 'Donec vitae nisi.', '24');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Senior Cost Accountant', 'Sed accumsan felis. Ut at dolor quis odio consequat varius.', true, 100, 'Boston', 'IAR', 'Maecenas tristique, est et tempus semper, est quam pharetra magna, ac consequat metus sapien ut nunc.', '26');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Payment Adjustment Coordinator', 'Curabitur in libero ut massa volutpat convallis. Morbi odio odio, elementum eu, interdum eu, tincidunt in, leo.', true, 25, 'Chicago', 'Report Writing', 'Maecenas pulvinar lobortis est.', '19');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Design Engineer', 'Duis bibendum. Morbi non quam nec dui luctus rutrum.', true, 11, 'Miami', 'EEPROM', 'Suspendisse accumsan tortor quis turpis.', '33');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Operator', 'Nulla neque libero, convallis eget, eleifend luctus, ultricies eu, nibh. Quisque id justo sit amet sapien dignissim vestibulum.', true, 77, 'Boston', 'User Interface Design', 'Aenean fermentum.', '30');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('VP Marketing', 'Donec vitae nisi. Nam ultrices, libero non mattis pulvinar, nulla pede ullamcorper augue, a suscipit nulla elit ac nulla.', false, 56, 'Boston', 'IRI', 'Duis consequat dui nec nisi volutpat eleifend.', '37');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Pharmacist', 'Phasellus id sapien in sapien iaculis congue. Vivamus metus arcu, adipiscing molestie, hendrerit at, vulputate vitae, nisl.', false, 96, 'Los Angeles', 'NRF', 'Praesent blandit lacinia erat.', '21');
insert into coop_connect.job_position (title, description, still_accepting, num_applicants, location, desired_skills, targeted_majors, company_id) values ('Physical Therapy Assistant', 'In hac habitasse platea dictumst. Aliquam augue quam, sollicitudin vitae, consectetuer eget, rutrum at, lorem.', false, 33, 'Boston', 'Zines', 'In hac habitasse platea dictumst.', '3');
